  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-2">
        ...
        <div className="flex flex-col gap-2 mb-2 animate-in slide-in-from-bottom-2">
          {actions.map(action => (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all"
            >
      ...
      <button
        ...
        className={`w-14 h-14 rounded-full shadow-xl flex items-center justify-center text-white text-2xl transition-all
          ${isOpen
