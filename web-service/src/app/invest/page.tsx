...
export const metadata = {
  ...
  description:
    "AI가 24시간 뉴스·시장·센티먼트를 크로스 분석하여 투자 시그널을 도출합니다.",
};
...
export default function InvestPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      ...
      {/* CTA 버튼 */}
      <div className="max-w-5xl mx-auto px-4 mt-4 text-center flex items-center justify-center gap-3 flex-wrap">
        <Link
          href="/invest/market"
        ...
        <Link
          href="/invest/sources"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 text-white text-sm font-semibold hover:shadow-lg transition-all hover:scale-105"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
